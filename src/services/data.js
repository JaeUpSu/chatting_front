...
export const rooms = [
  {
    id: "1",
    img: "https://thumb.mt.co.kr/06/2020/09/2020091115075836165_1.jpg/dims/optimize/",
    contents: "전세 3억",
    size: "29.82m²",
    address: "서초구 반포동",
    info: "역세권 깨끗하고 깔끔한 전세투룸",
    seller: {
      brokerActive: true,
      ownerActive: false,
    },
...
export const HouseRegisterValues = [
  ...
  { eng: "option", kor: "추가옵션", isRequired: false },
  { eng: "Safetyoption", kor: "안전옵션", isRequired: false },
];
